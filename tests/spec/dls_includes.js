...
describe("Downloads with jpg,js,mp4 included", function () {
	...
	describe("direct script with plain text mime", function () {
		let dlInfo = REQ.direct_js_ext_plain_mime;
		let action = req(dlInfo);
		it("is ignored", function () {
			expect(action).toEqual(ReqFilter.ACT_GRAB);
		});
